# RailsAdmin config file. Generated on October 25, 2013 13:42
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Mysky', 'Admin']
  ...
  # config.excluded_models = ['Skyimage', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Skyimage', 'User']
  ...
  # config.model 'Skyimage' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your skyimage.rb model definition
  ...
  #     configure :skyimages, :has_many_association 
